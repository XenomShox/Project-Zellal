...
subst = open('./results/subst.dic', 'w', encoding="utf-16-le")
subst.write('\ufeff')
...
for i in range(first, last + 1):
    website = urlopen("http://127.0.0.1:"+sys.argv[2]+ urlstring + "/vidal-Sommaires-Substances-"+chr(i)+".htm").read().decode("utf-8")
